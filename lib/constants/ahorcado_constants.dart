  ...
  static const Map<String, Map<String, List<String>>> palabrasPorTematica = {
    ...
    'comida': {
      'facil': [
        ...
        'PERA', 'UVA', 'MELON', 'SANDIA', 'PLATANO', 'DURAZNO', 'CEREZA', 'CIRUELA',
        'MANZANA', 'KIWI', 'PINA', 'COCO', 'PAPAYA', 'AGUACATE', 'TOMATE', 'PEPINO',
        'LECHUGA', 'CEBOLLA', 'AJO', 'SAL', 'AZUCAR', 'MIEL', 'CAFE', 'TE'
      ],
      'medio': [
        'ESPAGUETI', 'HAMBURGUESA', 'ENSALADA', 'CHOCOLATE', 'GALLETA',
        'SANDWICH', 'LASAGNA', 'EMPANADA', 'TORTILLA', 'GUACAMOLE', 'BURRITO',
        'RAVIOLI', 'CANNOLI', 'TIRAMISU', 'PAELLA', 'GAZPACHO', 'CEVICHE',
        'TAMALES', 'AREPAS', 'CHURRASCO', 'ASADO', 'MILANESA', 'FEIJOADA',
        'SUSHI', 'RAMEN', 'TEMPURA', 'YAKITORI', 'KIMCHI', 'BIBIMBAP', 'CURRY',
        'NAAN', 'SAMOSA', 'BIRYANI', 'FALAFEL', 'HUMMUS', 'SHAWARMA', 'KEBAB'
      ],
      'dificil': [
        'QUESADILLA', 'CHILAQUILES', 'ENCHILADAS', 'RATATOUILLE', 'CROISSANT',
        'CARPACCIO', 'BRUSCHETTA', 'ZANAHORIA', 'BERENJENA', 'CALABACIN',
        'BOUILLABAISSE', 'CASSOULET', 'ESCARGOTS', 'FOIEGRAS', 'BOQUERONES',
        'GAZPACHO', 'PROSCIUTTO', 'MOZZARELLA', 'GORGONZOLA', 'PARMESANO',
        'VINAGRETA', 'MAYONESA', 'BECHAMEL', 'HOLLANDAISE', 'CHIMICHURRI',
        'GUACHINANGO', 'AGUACHILE', 'MOLCAJETE', 'TLAYUDA', 'POZOLE',
        'COCHINILLO', 'CORDERO', 'VENADO', 'CODORNIZ', 'EMBUTIDOS'
      ]
    },
    'ciencia': {
      'facil': [
        'ATOMO', 'CELULA', 'PLANTA', 'ANIMAL', 'TIERRA', 'LUNA', 'SOL', 'ESTRELLA',
        'AGUA', 'FUEGO', 'AIRE', 'LUZ', 'CALOR', 'FRIO', 'SONIDO', 'COLOR',
        'HUESO', 'MUSCULO', 'SANGRE', 'CORAZON', 'CEREBRO', 'PULMON', 'ESTOMAGO',
        'OJO', 'OIDO', 'NARIZ', 'LENGUA', 'PIEL', 'DIENTE', 'PELO', 'UNA',
        'ROCA', 'ARENA', 'ORO', 'PLATA', 'HIERRO', 'COBRE', 'VOLCAN', 'TERREMOTO'
      ],
      'medio': [
        'OXIGENO', 'HIDROGENO', 'CARBONO', 'NITROGENO', 'FOTOSINTESIS', 'EVAPORACION',
        'CONDENSACION', 'PRECIPITACION', 'GRAVEDAD', 'ENERGIA', 'ELECTRICIDAD',
        'MAGNETISMO', 'RADIACION', 'TEMPERATURA', 'PRESION', 'VOLUMEN', 'DENSIDAD',
        'MOLECULA', 'COMPUESTO', 'ELEMENTO', 'REACCION', 'CATALISIS', 'DIFUSION',
        'CROMOSOMA', 'GENETICA', 'EVOLUCION', 'ESPECIE', 'ECOSISTEMA', 'HABITAT',
        'CADENA', 'VERTEBRADO', 'INVERTEBRADO', 'REPTIL', 'ANFIBIO', 'MAMIFERO'
      ],
      'dificil': [
        'ELECTROMAGNETISMO', 'TERMODINAMICA', 'RELATIVIDAD', 'CUANTICA',
        'BIOQUIMICA', 'FARMACOLOGIA', 'NEUROCIENCIA', 'ASTROFISICA', 'GEOLOGIA',
        'PALEONTOLOGIA', 'ANTROPOLOGIA', 'ARQUEOLOGIA', 'EPIDEMIOLOGIA',
        'FOTOSINTESIS', 'GLUCOLISIS', 'RESPIRACION', 'MITOCONDRIA', 'CLOROPLASTO',
        'RIBOSOMA', 'NUCLEOTIDO', 'PROTEINA', 'ENZIMA', 'HORMONA', 'ANTICUERPO',
        'BACTERIOFAGO', 'CROMOSOMA', 'MUTACION', 'TRANSCRIPCION', 'TRADUCCION',
        'ISOTOPO', 'RADIACTIVIDAD', 'SEMICONDUCTORAS', 'SUPERCONDUCTOR'
      ]
    },
    'deportes': {
      'facil': [
        'FUTBOL', 'TENIS', 'GOLF', 'BOXEO', 'NATACION', 'ATLETISMO', 'CICLISMO',
        'BALONCESTO', 'VOLEIBOL', 'BEISBOL', 'RUGBY', 'HOCKEY', 'ESQUI', 'SURF',
        'KARATE', 'JUDO', 'TAEKWONDO', 'GIMNASIA', 'EQUITACION', 'PESCA', 'CAZA',
        'REMO', 'VELA', 'BUCEO', 'ESCALADA', 'CAMINATA', 'CARRERA', 'SALTO',
        'LANZAMIENTO', 'PELOTA', 'BALON', 'RAQUETA', 'BATE', 'GUANTE', 'CASCO',
        'RED', 'ARO', 'META', 'GOL', 'PUNTO'
      ],
      'medio': [
        'BALONCESTO', 'BALONMANO', 'WATERPOLO', 'SOFTBOL', 'CRICKET', 'BADMINTON',
        'ESGRIMA', 'ARQUERIA', 'HALTEROFILIA', 'PENTATHLON', 'TRIATHLON',
        'MARATON', 'DECATHLON', 'VELOCIDAD', 'RESISTENCIA', 'POTENCIA', 'AGILIDAD',
        'FLEXIBILIDAD', 'COORDINACION', 'EQUILIBRIO', 'PRECISION', 'ESTRATEGIA',
        'TACTICA', 'COMPETENCIA', 'CAMPEONATO', 'TORNEO', 'OLIMPIADAS', 'MUNDIAL',
        'MEDALLA', 'TROFEO', 'PREMIO', 'VICTORIA', 'DERROTA', 'EMPATE', 'ARBITRO'
      ],
      'dificil': [
        'LEVANTAMIENTO', 'POWERLIFTING', 'CALISTENIA', 'CROSSFIT', 'CULTURISMO',
        'MOTOCROSS', 'AUTOMOVILISMO', 'MOTOCICLISMO', 'PARACAIDISMO', 'PARAPENTE',
        'ALPINISMO', 'ESPELEOLOGIA', 'PARKOUR', 'SNOWBOARD', 'SKATEBOARD',
        'BREAKDANCE', 'CAPOEIRA', 'MUAYTHAI', 'KICKBOXING', 'LUCHA', 'SUMO',
        'LANZAMIENTO', 'JABALINA', 'DISCO', 'MARTILLO', 'PERTIGA', 'VALLAS',
        'ESLALON', 'DESCENSO', 'COMBINADA', 'SUPERGIGANTE', 'BIATHLON',
        'SINCRONIZADA', 'TRAMPOLIN', 'ANILLAS', 'PARALELAS', 'BARRA'
      ]
    },
    'profesiones': {
      'facil': [
        'DOCTOR', 'ENFERMERA', 'MAESTRO', 'POLICIA', 'BOMBERO', 'COCINERO',
        'MESERO', 'CAJERO', 'VENDEDOR', 'CHOFER', 'PILOTO', 'MARINERO',
        'SOLDADO', 'CANTANTE', 'ACTOR', 'BAILARIN', 'PINTOR', 'ESCULTOR',
        'MUSICO', 'POETA', 'ESCRITOR', 'PERIODISTA', 'FOTOGRAFO', 'MODELO',
        'JARDINERO', 'GRANJERO', 'PESCADOR', 'CAZADOR', 'MINERO', 'CARPINTERO',
        'PLOMERO', 'ELECTRICISTA', 'ALBANIL', 'HERRERO', 'ZAPATERO', 'SASTRE',
        'BARBERO', 'PELUQUERO', 'DENTISTA', 'VETERINARIO'
      ],
      'medio': [
        'INGENIERO', 'ARQUITECTO', 'ABOGADO', 'CONTADOR', 'ECONOMISTA', 'BANQUERO',
        'ADMINISTRADOR', 'SECRETARIO', 'RECEPCIONISTA', 'GERENTE', 'SUPERVISOR',
        'PSICOLOGO', 'SOCIOLOGO', 'ANTROPOLOGO', 'HISTORIADOR', 'GEOGRAFO',
        'BIOLOGO', 'QUIMICO', 'FISICO', 'MATEMATICO', 'ASTRONOMO', 'GEOLOGO',
        'FARMACEUTICO', 'ENFERMERO', 'CIRUJANO', 'PEDIATRA', 'CARDIOLOGO',
        'DERMATOLOGO', 'OFTALMOLOGO', 'NUTRICIONISTA', 'FISIOTERAPEUTA',
        'RADIOLOGO', 'ANESTESIOLOGO', 'PATOLOGO', 'PARAMEDICO', 'OPTOMETRISTA'
      ],
      'dificil': [
        'NEUROCIRUJANO', 'OTORRINOLARINGOLOGO', 'GASTROENTEROLOGO', 'TRAUMATOLOGO',
        'ENDOCRINOLOGO', 'HEMATOLOGO', 'NEFROLOGO', 'ONCOLOGO', 'UROLOGO',
        'GINECOLOGO', 'OBSTETRA', 'NEONATOLOGO', 'GERIATRA', 'EPIDEMIOLOGO',
        'INVESTIGADOR', 'CIENTIFICO', 'ASTROFISICO', 'PALEONTOL OGO',
        'ARQUELOGO', 'OCEANOGRAFO', 'METEOROLOGO', 'SISMOLO GO', 'VULCANOLOGO',
        'CARTOGRAFO', 'TOPOGRAFO', 'AGRONOMOLOGO', 'VETERINARIO', 'ZOOTECNISTA',
        'BIOTECNOLOGO', 'NANOTECNOLOGO', 'PROGRAMADOR', 'DESARROLLADOR',
        'ARQUITECTO', 'DISEÑADOR', 'INGENIERO'
      ]
    },
    'geografia': {
      'facil': [
        'MONTE', 'VALLE', 'LLANURA', 'COLINA', 'MESETA', 'PENINSULA', 'ISLA',
        'CONTINENTE', 'OCEANO', 'MAR', 'LAGO', 'RIO', 'ARROYO', 'CASCADA',
        'PLAYA', 'COSTA', 'BAHIA', 'GOLFO', 'ESTRECHO', 'CANAL', 'PUERTO',
        'DESIERTO', 'SELVA', 'BOSQUE', 'PRADERA', 'TUNDRA', 'SABANA', 'TAIGA',
        'VOLCAN', 'CRATER', 'CUEVA', 'CAÑON', 'GLACIAR', 'ICEBERG', 'POLO',
        'ECUADOR', 'TROPICO', 'HEMISFERIO', 'LATITUD', 'LONGITUD'
      ],
      'medio': [
        'CORDILLERA', 'MONTANA', 'ALTIPLANO', 'DEPRESION', 'ACANTILADO', 'FJORDO',
        'ARCHIPIELAGO', 'ATOLON', 'LAGUNA', 'PANTANO', 'MANGLAR', 'ESTUARIO',
        'DELTA', 'MEANDRO', 'AFLUENTE', 'CUENCA', 'VERTIENTE', 'NACIMIENTO',
        'DESEMBOCADURA', 'CATARATA', 'RAPIDOS', 'REMOLINO', 'CORRIENTE', 'MAREA',
        'OLEAJE', 'TSUNAMI', 'HURACAN', 'TORNADO', 'CICLON', 'TIFON', 'MONZON',
        'TERREMOTO', 'TSUNAMI', 'AVALANCHA', 'ALUD', 'ERUPCION', 'TEMBLOR'
      ],
      'dificil': [
        'OROGRAFIA', 'HIDROGRAFIA', 'GEOMORFOLOGIA', 'TECTONICA', 'SEDIMENTACION',
        'EROSION', 'METEORIZ ACION', 'CONTINENTAL', 'OCEANICA', 'SUBMARINA',
        'FALLA', 'PLIEGUE', 'ANTICLINAL', 'SINCLINAL', 'BASALTO', 'GRANITO',
        'CALIZA', 'ARENISCA', 'PIZARRA', 'MARMOL', 'CUARZO', 'FELDESPATO',
        'ESTRATIFICACION', 'FOSILIZACION', 'MINERALIZACION', 'CRISTALIZACION',
        'MAGMATISMO', 'VULCANISMO', 'SISMICIDAD', 'SUBSIDENCIA', 'ELEVACION',
        'DEPRESION', 'HUNDIMIENTO', 'LEVANTAMIENTO', 'SUBDUCCION', 'DIVERGENCIA'
      ]
    }
  };

  // Temáticas disponibles
  static const List<String> tematicas = ['general', 'animales', 'paises', 'comida', 'ciencia', 'deportes', 'profesiones', 'geografia'];
