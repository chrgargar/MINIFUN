// DATABASE DEACTIVATED - All database functionality has been disabled
// This file is kept for reference but all classes and methods are non-functional
...
/// DATABASE DEACTIVATED - Servicio para gestionar la base de datos SQLite local
class DatabaseService {
  ...
  Future<UserModel> createUser({
    ...
    // DATABASE DEACTIVATED
    throw Exception('Database is deactivated');
