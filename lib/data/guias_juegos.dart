...
class GuiasJuegos {
  ...
  // Guía para Buscaminas
  static const buscaminasObjetivo =
      'Revela todas las casillas que no contienen minas y marca las minas con banderas.';

  static const buscaminasInstrucciones = [
    'Toca una casilla para revelarla.',
    'Mantén pulsada una casilla para colocar o quitar una bandera.',
    'Los números indican cuántas minas hay en las casillas adyacentes.',
    'Si revelas una mina, pierdes el nivel.',
    'Gana al revelar todas las casillas seguras.',
  ];

  static const buscaminasControles = [
    ControlItem(
      icon: '👆',
      name: 'Revelar',
      description: 'Toca una casilla para revelarla',
    ),
    ControlItem(
      icon: '🚩',
      name: 'Bandera',
      description: 'Mantén pulsada una casilla para marcar o desmarcar una bandera',
    ),
  ];
}
